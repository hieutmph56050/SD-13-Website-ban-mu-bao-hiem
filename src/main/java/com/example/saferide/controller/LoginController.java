...
public class LoginController {
    ...
    public ResponseEntity<?> login(@RequestBody TaiKhoan taiKhoan) {
        try {
            ...
            response.put("user", Map.of("id", authenticatedUser.getId(), "username", authenticatedUser.getTenDangNhap(), "name", authenticatedUser.getTen(), "role", authenticatedUser.getIdVaiTro().getTen()));
