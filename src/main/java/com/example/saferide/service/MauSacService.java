...
public class MauSacService {
    ...
    // Thêm phương thức tìm kiếm và phân trang
    public Page<MauSac> search(String ma, String ten, String moTa, int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        return mausacRepository.search(ma, ten, moTa, pageable);
    }
}
