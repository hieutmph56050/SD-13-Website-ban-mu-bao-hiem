...
<form action="/spchitiet/index/update" method="post">
    <div>ID: <input type="text" name="id" value="${spchitiet.id}" readonly/></div>
    <br>
    <div>Mã sản phẩm chi tiết: <input type="text" name="ma" value="${spchitiet.ma}"></div>
    <br>
    <div>
        Sản phẩm:
    ...
    <br>
    <div>Số lượng: <input type="number" name="sl" value="${spchitiet.sl}"></div>
    <br>
    <div>Đơn giá: <input type="number" name="donGia" value="${spchitiet.donGia}"></div>
    <br>
    <div>Xuất xứ: <input type="text" name="xuatXu" value="${spchitiet.xuatXu}"></div>
    <br>
    <div>Mô tả chi tiết: <input type="text" name="moTaCT" value="${spchitiet.moTaCT}"></div>
    <br>
    <div>Trạng thái: <input type="text" name="tt" value="${spchitiet.tt}"></div>
    <br>
    <button>Sửa</button>
</form>
